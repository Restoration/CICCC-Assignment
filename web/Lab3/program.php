		<?php
			include("header.php");
		?>
<div id="program_bg" class="main_bg"></div>
<div id="program">
	<div id="programInner" class="wrapInner">
		<h2>Program</h2>

	<section class="programBox">
	<h3><i class="fas fa-check"></i>Professional Training and Post Graduate Program</h3>
	<img src="img/program/program-1.jpg" alt="program-1" />
	<p>
	...
	<section class="programBox">
	<h3><i class="fas fa-check"></i>This intense training program prepares boys and girls for a professional career in dance.</h3>
	<img src="img/program/program-2.jpg" alt="program-2" />
	<p>
	Foundation Training Program
	The Foundation Training Program is for the amateur/part-time dancer aged 7-12yrs who loves to dance and  wants to work on poise, posture, and discipline together with technique, musicality, and artistry. A minimum of twice a week is required and students (if ready) are encouraged to enter an ISTD ballet exam each year. This program is designed to train young boys and girls to a higher level of ability, offering them the opportunity to audition for the Professional Training Program.</p>
	</section>

	<section class="programBox">
	<h3><i class="fas fa-check"></i>Foundation students will participate in the year-end presentation on stage.</h3>
	<img src="img/program/program-3.jpg" alt="program-3"/>
	<p>
	...
	<p>ISTD Graded & Vocational exams are recognized internationally and acknowledged by the BC Ministry of Education, with Vocational certification awarding school credits.</p>
	</section>

	<section class="programBox">
	<h3><i class="fas fa-check"></i>Pre-Ballet Program</h3>
	<img src="img/program/program-4.jpg" alt="program-4" />
	<p>Children aged 3-6yrs attend classes once or twice a week.  Our young ballerina program encourages age appropriate creativity, musicality, and physicality.  Children gain confidence, poise, and a solid frame work on which to build classical ballet technique. </p>


	<p>The program offers boys and girls the opportunity to present informal in-house performances for their parents each term.</p>
	</section>
